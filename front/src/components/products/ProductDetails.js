      ...
      <div className='row d-flex justify-content-around'>
        ...
        <hr />
              <div className="stockCounter d-inline">
                ...
                <button type="button" id="carrito_btn" className="btn btn-success d-inline ml-4" disabled={product.inventario===0} onClick ={addToCart}>Agregar al Carrito</button>
              <hr />
              ...
              <hr />
              <p id="vendedor">Vendido por: <strong>{product.proveedor}</strong></p>
              <button id="btn_review" type="button" className="btn btn-success mt-4" 
              data-toggle="modal" data-target="#ratingModal">Dejanos tu Opinion</button>
              <div className="alert alert-danger mt-5" type="alert">Inicia Sesión para dejar tu review</div>

          {/*Mensaje emergente para dejar opiniones y calificaciones*/}
                    ...
                    <div className="modal-dialog" role="document">
                      <div className="modal-content">
                        <div className="modal-header">
                          <h5 className="modal-title" id="ratingModalLabel">Enviar Opinion</h5>
